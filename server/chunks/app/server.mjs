import { getCurrentInstance, version as version$1, defineComponent, computed, ref, h, resolveComponent, reactive, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, provide, onErrorCaptured, unref, inject } from 'vue';
...
import { ssrInterpolate, ssrRenderSuspense, ssrRenderComponent } from 'vue/server-renderer';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="hello" data-v-c887e025> Hello World - Nuxt v.${ssrInterpolate(version)}.0.0 at GitHub Pages </div><div class="hellobody" data-v-c887e025> Make sure to take a look at the Readme file before installing :-) </div><!--]-->`);
    };
  }
};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c887e025"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.08caa342.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
